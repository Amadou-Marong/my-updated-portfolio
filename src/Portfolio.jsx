    ...
    return (
      <div className='pt-16 pb-10 sm:pb-16 lg:gb-16 max-w-[1400] mx-auto] px-10'>
        ...
        <div className='grid lg:grid-cols-3 md:grid-cols-2 gap-6'>
          ...
          <div className="rounded-xl bg-gradient-to-b from-gray-500 to-gray-800 overflow-hidden shadow-xl z-10">
            <a href="https://ahmad-tours.netlify.app" className="group col-span-3">
            ...
            <div className="flex flex-row gap-3 justify-end text-white mb-3 mr-3">
              <a href="#" className="cursor-pointer"><AiFillGithub className='w-[35px] h-auto'/> </a>
              <a href="https://ahmad-tours.netlify.app" className="cursor-pointer"><AiFillChrome className='w-[35px] h-auto'/> </a>
            </div>  
          </div>
